...
public interface Bank {
	 ...
	 int amountDeposite(int accountNumber,int amount)throws InvalidAccountNumberException;
	 int fundTransfer(int accouontNumber,int accountnumber1,int amount)throws InvalidAccountNumberException,InsufficientBalanceException;
